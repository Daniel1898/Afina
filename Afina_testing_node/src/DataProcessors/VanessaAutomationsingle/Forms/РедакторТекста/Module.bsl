...
Процедура ПоказатьСтраницуWelcome(НедавноЗагруженныеФичи) Экспорт
	...
	МассивКомандЗапуска.Добавить(Новый Структура("event,href,gliph,name", "WELCOME_LAUNCH", "VanessaEditorБыстроСоздатьВременныйФичаФайл()", "symbol-file", Ванесса.Локализовать("Быстро создать временный фича файл…")));
